...
describe "site_reviews/new" do
  before(:each) do
    assign(:site_review, stub_model(SiteReview,
      :site_id => 1,
      :reviewedby => "MyString",
      :acctepted => false,
  ...
  it "renders new site_review form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => site_reviews_path, :method => "post" do
