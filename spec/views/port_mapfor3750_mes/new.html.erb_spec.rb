...
describe "port_mapfor3750_mes/new" do
  before(:each) do
    assign(:port_mapfor3750_me, stub_model(PortMapfor3750Me,
      :cabinet_id => 1,
      :site_id => 1,
      :port => "MyString",
  ...
  it "renders new port_mapfor3750_me form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => port_mapfor3750_mes_path, :method => "post" do
